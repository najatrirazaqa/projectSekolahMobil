        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                <div class="container-fluid">
                    ...
                    <a href="addMobil.php" class="btn btn-primary ms-2">Tambah Data Mobil</a>
            ...
            <!-- Page content-->
            <h2 class=" d-flex justify-content-center m-auto pt-2 pb-2">Mobil</h2>
                ...
                <div class="card-body ">
                    <table width='80%' border=1 class="table table-striped ">
                        ...
                        while ($user_data = mysqli_fetch_array($result)) {
                            ...
                            echo "<td><a href='editMobil.php?kode_mobil=$user_data[kode_mobil]'><i class='fa-solid fa-pen-to-square'></i></a> |
            <a href='deleteMobil.php?kode_mobil=$user_data[kode_mobil]'><i class='fa-solid fa-trash text-danger'></i></a></td></tr>";
                        }
                        ?>
