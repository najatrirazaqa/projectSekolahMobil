...
<body>
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="card m-auto mt-5" style="width: 25rem; height: 25rem; ">
        <div class="card-body ">
          <form action="addMobil.php" method="post" name="form1">
  ...
  if (isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO dataMobil(kode_mobil, nama_mobil, harga, warna, stok)
        VALUES('$kode_mobil', '$nama_mobil', '$harga', '$warna', '$stok')");

    echo "User added succesfully. <a href='tableMobil.php'>View Users</a>";
  }
  ?>
