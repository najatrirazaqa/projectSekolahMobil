...
<body>
  <div class="d-flex" id="wrapper">
    <!-- Sidebar-->
    <div class="border-end bg-white shadow" id="sidebar-wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo vel ab adipisci dolore, consequatur quod quas vitae, aspernatur iste corrupti ex amet laudantium! Perferendis consectetur vel dolorem dolore enim maiores.</p>
      </div>
    </div>
  </div>
  <!-- Bootstrap core JS-->
